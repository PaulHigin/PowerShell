...
- `Test-Connection` - Improve Logic and Output (#10697) (Thanks @vexx32!)
- Stop blindly setting `$?` to true for `ParenExpression`, `SubExpression` and `ArrayExpression` (#11040)
...
- `Group-Object` - Use Case-Sensitive Hashtable for `-CaseSensitive` `-AsHashtable` (#11030) (Thanks @vexx32!)
...
- Add back `Out-Printer` command (#10906)
...
- Add `$env:__SuppressAnsiEscapeSequences` to control whether toΓÇª (#10814)
...
- Allow semantic versions to be passed to `NormalizeVersion` funΓÇª (#11087)
- Bump .NET core framework to `3.1-preview.3` (#11079)
- Bump PSReadLine from `2.0.0-beta5` to `2.0.0-beta6` in /src/Modules (#11078)
- Bump Newtonsoft.Json from `12.0.2` to `12.0.3` (#11038)
- Bump Newtonsoft.Json (#11037)
...
- Update AppX Manifest and Packaging module to conform to MS StoΓÇª (#10878)
